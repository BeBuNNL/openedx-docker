...
STATICFILES_STORAGE = config(
    ...
    "STATICFILES_STORAGE", default="lms.envs.storage.CDNProductionStorage"
)
...
PLATFORM_NAME = config("PLATFORM_NAME", default="Open edX Platform Beta v2")
PLATFORM_DESCRIPTION = config(
    "PLATFORM_DESCRIPTION", default="@github/nnlbebu"
)
